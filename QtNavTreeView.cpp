...
void QtNavTreeView::mousePressEvent(QMouseEvent* event)
{
...
QtNavTreeView::QtNavTreeView(QWidget *parent)
	...
	m_model(new QStandardItemModel(this)),
	m_bgColor(QColor(252,62,86)),
	m_hoverBgColor(QColor(252, 76, 73)),
	m_checkedBgColor(QColor(254, 107, 47)),
	m_textColor(QColor("#FFFFFF")),
	m_hoverTextColor(QColor("#3F3F3F")),
	m_checkedTextColor(QColor("#F0F0F0")),
	m_lineColor(QColor("#404244"))
{
                              ...
                              const QModelIndex &index) const
{
    ...
    QRect bgRect(m_view->x() - 10, option.rect.top(), m_view->width()+10, option.rect.height());
